...
class localdeatendimento{
    ...
    public $whatsapp;
     ...
     public function lista(){
        ...
        $sql  = "SELECT * FROM localdeatendimento INNER JOIN medico ON localdeatendimento.codmedico = medico.codmedico;";
    ...
    public function visualizar($localdeatendimento){
        $pdo = Conexao::conexao();
        $sql = "SELECT * FROM localdeatendimento where coddeatendimento =".$coddeatendimento->getcoddeatendimento();
        $consulta = $pdo->query($sql);
